...
exports.getPersonalizedRecommendations = exports.getRecentlyViewed = exports.getUserInteractions = exports.trackInteraction = void 0;
...
const trackInteraction = async (req, res) => {
    try {
        ...
        const validatedData = interaction_1.InteractionSchema.parse(req.body);
        ...
        return res.status(200).json({
            ...
            data: {
                interactions: rawInteractions.map(interaction => {
                    var _a;
                    return (Object.assign(Object.assign({}, interaction), { product: interaction.product ? {
                            ...
                            salePrice: (_a = interaction.product.salePrice) !== null && _a !== void 0 ? _a : undefined,
        ...
        return res.status(200).json({
            ...
            data: {
                recentViews: rawRecentViews.map(view => {
                    var _a;
                    return (Object.assign(Object.assign({}, view), { product: view.product ? {
                            id: view.product.id,
